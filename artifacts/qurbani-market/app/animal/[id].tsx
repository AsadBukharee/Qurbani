    ...
    <View style={[styles.root, { backgroundColor: colors.navy }]}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          style={[styles.callBtn, { backgroundColor: colors.teal, borderColor: colors.teal }]}
        >
          <Feather name="message-square" size={18} color={colors.isLight ? "#fff" : colors.navy} />
          <Text style={[styles.callBtnText, { color: colors.isLight ? "#fff" : colors.navy }]}>
